...
export class PendingXHR {
  ...
  constructor(page: Page) {
    ...
    page.on('request', this.requestListener as (request: Request) => void)
    page.on(
      'requestfailed',
      this.requestFailedListener as (request: Request) => void
    )
    page.on(
      'requestfinished',
      this.requestFinishedListener as (request: Request) => void
    )
  }
